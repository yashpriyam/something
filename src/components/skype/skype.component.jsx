...
const Skype = () => (
    <div className="form-style-3">
        ...
        <fieldset>
            ...
            <label for="field2"><span>Interviewer/s<span className="required">*</span></span><input type="email" className="input-field" name="field2" value="" /></label>
            <label for="field1"><span>Skype Interview Link<span className="required">*</span></span><input type="text" className="input-field" name="field1" value="" /></label>
            <label for="field2"><span> Interview Time<span className="required">*</span></span><input type="email" className="input-field" name="field2" value="" /></label>
            <label for="field3"><span>Interview Date <span className="required">*</span></span><input type="text" className="input-field" name="field3" value="" /></label>
